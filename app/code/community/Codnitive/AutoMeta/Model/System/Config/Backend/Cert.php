...
class Codnitive_AutoMeta_Model_System_Config_Backend_Cert extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if ($value) {
            try {
                ...
                if ($condition) {
                    $err = Mage::helper('autometa')->__('%s extension not registered.', 
                            Mage::helper('autometa')->__(Codnitive_AutoMeta_Model_Config::EXTENSION_NAME));
