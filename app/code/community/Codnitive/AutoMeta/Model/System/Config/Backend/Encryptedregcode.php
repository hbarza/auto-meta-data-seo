...
class Codnitive_AutoMeta_Model_System_Config_Backend_Encryptedregcode extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        $value = (string) $this->getValue();
        if (empty($value)) {
            Mage::throwException(Mage::helper('autometa')->__('%s is required.', 
